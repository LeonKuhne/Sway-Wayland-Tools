...
/home/x/.tools/googliser.sh -p "$QUERY $@" -L -a wide -m 4mp -n 1 -o /data/Downloads #nothing should go to downloads, -o uses local dir
URL=$(head -n 1 /home/x/.tools/download.links.list)
echo $URL
wget -O /data/Downloads/image.today $URL
rm /home/x/.tools/download.links.list
