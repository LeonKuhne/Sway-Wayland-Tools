...
#convert -gravity center -resize 4740x2340^ /data/Downloads/image.today /data/Downloads/image_today.png
# individual cropings
#convert -crop 1440x900+1600+0 /data/Downloads/image_today.png /data/Downloads/image_today_1.png
#convert -crop 1920x1080+0+960 /data/Downloads/image_today.png /data/Downloads/image_today_2.png
#convert -crop 900x1440+1920+900 /data/Downloads/image_today.png /data/Downloads/image_today_3.png
convert -crop 1920x1080+2820+900 /data/Downloads/image_today.png /data/Downloads/image_today_4.png

# show the background images
sway output HDMI-A-1 bg /data/Downloads/image_today_1.png fill
sway output DVI-D-2 bg /data/Downloads/image_today_2.png fill
sway output DVI-D-1 bg /data/Downloads/image_today_3.png fill
sway output DP-1 bg /data/Downloads/image_today_4.png fill
